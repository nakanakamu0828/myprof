...
exports.handler = function (event, context, callback) {
  callback(null, {
    ...
    body: JSON.stringify({
      ...
      categories: ['Technology', 'Web Developer', 'Software Development', 'PHPer', 'Laraveler'],
      skills: ['html5-original', 'css3-original', 'javascript-original', 'jquery-original', 'php-plain', 'laravel-plain', 'symfony-original', 'zend-plain', 'ruby-plain', 'rails-plain-wordmark', 'linux-original', 'mysql-original', 'redis-original', 'nginx-original'],
      works: [{
        image_src: 'https://nakamu.life/img/smail.png',
        image_alt: 'SMail',
        title: '✉️一括メール配信サービス',
        description: 'SESマネージメント企業の営業メール配信システム。クライアントの管理からメールの一斉送信＆予約送信が可能なサービス。<br><br>',
        skills: ['html5-original', 'css3-original', 'javascript-original', 'jquery-original', 'php-plain', 'laravel-plain', 'mysql-original']
      }, {
        ...
        skills: ['html5-original', 'css3-original', 'javascript-original', 'jquery-original', 'php-plain', 'symfony-original', 'mysql-original', 'redis-original']
      }],
      socials: {
